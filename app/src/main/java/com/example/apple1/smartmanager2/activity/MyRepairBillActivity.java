 ...
 */
public class MyRepairBillActivity extends Activity implements View.OnClickListener {
    //申明对象
    ...
    private String urlFinish=Sql_URL.my_url+"/sm/service_id02.php";
    ...
    private void init() {
        ...
        han = new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                super.handleMessage(msg);
                if (Jsmess.equals("1")){
                    Toast.makeText(MyRepairBillActivity.this, "连接失败", Toast.LENGTH_SHORT).show();
                }else {
            ...
            private void parseJSONWithJSONObject(String Jsmess) {
                ...
                try {
                    ...
                    String state=temp.getString("states");
                    repairDetail.setState(state);
