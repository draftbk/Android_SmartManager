 ...
 */
public class RepairAdapterSearch extends ArrayAdapter<RepairRecordSearch> {
    ...
    public RepairAdapterSearch(Context context, int textViewResourceId, List<RepairRecordSearch> objects, ListView listView){
    ...
    public View getView( final int position,View convertView,ViewGroup parent){
        RepairRecordSearch repairRecord=getItem(position);
